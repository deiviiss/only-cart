...
export function ProductSearch({
  ...
  return (
    <div className='relative flex w-full max-w-96'>
      ...
      <input
        className='peer block w-full rounded-none border border-black py-[9px] pl-10 text-sm outline-2 placeholder:text-gray-500 focus:outline-none focus:border-gray-400 bg-[#D9D8D3] transition-colors duration-200 ease-in-out'
